...
// Windows temporarily needs this file, https://github.com/module-federation/vite/issues/68
    ...
    const importMap = {
        ...
        "react": async () => {
          let pkg = await import("__mf__virtual/__mfe_internal__mfe__prebuild__react__prebuild__.js");
            return pkg;
        }
      ,
        "react-dom": async () => {
          let pkg = await import("__mf__virtual/__mfe_internal__mfe__prebuild__react_mf_2_dom__prebuild__.js");
            return pkg;
        }
      ,
        "zustand": async () => {
          let pkg = await import("__mf__virtual/__mfe_internal__mfe__prebuild__zustand__prebuild__.js");
            return pkg;
        }
